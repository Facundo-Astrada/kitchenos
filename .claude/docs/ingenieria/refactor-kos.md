...
|---|---|---|---|---|
| [recetario/page.tsx](app/(app)/recetario/page.tsx#L162) (3.167 líneas, 36 estados + 9 en `IAResultScreens.tsx`) | Forma 1: main + 12 componentes a nivel de módulo ([PlatosView:790](app/(app)/recetario/page.tsx#L790), [AudioRecorderModal:1147](app/(app)/recetario/page.tsx#L1147), [NuevaFichaScreen:1412](app/(app)/recetario/page.tsx#L1412)…) | Catálogo (soporte del core) | Ya no aplica igual — el move que este plan preveía para Recetario ya pasó, pero disparado por el ratchet en rojo (sep 2026), no por este plan | **Resuelto**: `IAResultScreen`+`IAMultiResultScreen` (~760 líneas) salieron a [`recetario/IAResultScreens.tsx`](app/(app)/recetario/IAResultScreens.tsx), con los tipos/helpers que usan ambos lados en [`recetario/shared.ts`](app/(app)/recetario/shared.ts) para no cerrar un import circular. 4005→3167 líneas. Si se retoma el resto del catálogo (`PlatosView`, `NuevaFichaScreen`), el plan de Carta aplica igual |
...
const TECHOS_LINEAS: Record<string, number> = {
  ...
  'app/(app)/recetario/page.tsx': 3300,    // bajado sep 2026, ver §3: IAResultScreen+IAMultiResultScreen salieron a su propio archivo
