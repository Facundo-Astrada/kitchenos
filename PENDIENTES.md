...
La tabla completa está en `PLAN-ACCESO-Y-USO-2026-08.md` § B5.3, con criterio de priorización. Las de mayor valor: **Modo Control del mise** (ícono `fact_check` sin etiqueta — es la vuelta rápida de plaza), **escalar por ingrediente de referencia** (doble tap, sin ninguna pista visual — resuelve "cuánto sale si tengo 3 kg de esto"), y **"Sugerir producción"** en OPS → Planificación. El Muro ya dejó de estar huérfano: el modo pantalla completa de Producción tiene el primer link que existe en toda OPS.
