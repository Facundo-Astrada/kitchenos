...
| 8 | **Carta** | `/carta` | Funcional | Ítems vinculados a recetas, food cost, 86, categorías dinámicas, tags dietarios, panel OPS unificado (plaza→sección→recipiente→cantidad), importación IA, foto, carta pública QR sin login (`/carta/[slug]`). Precio/FC visible solo admin. |
