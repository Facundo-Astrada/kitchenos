...
Cualquier miembro del equipo puede abrir CUALQUIER plaza y operarla completa (tildar, cambiar prioridades, mandar a producir), con los chips de plaza que están debajo del título. La plaza asignada en Equipo decide en cuál arranca cada uno, no cuál puede ver: en el servicio se cubre la plaza de al lado todo el tiempo. Si alguien pregunta cómo entrar a otra plaza, la respuesta son esos chips — no hay permiso que pedir.
...
Deja cada ítem en una sola línea, sin campos de números, para recorrer la plaza rápido mirando. Cada fila tiene tres controles: el tilde (ocupa el nombre entero), un badge de prioridad que cicla SP → P → REF con cada tap, y un "+" que despacha ese ítem con esa prioridad y SIN cantidad. La fila se pinta según cómo quedó: verde tachada si la tildaron, ámbar si la despacharon ("ya lo vi y va a salir", no se vuelve a mirar hasta el cierre), blanca si todavía no la decidieron. Resuelta de cualquiera de las dos formas, los dos botones se apagan en gris y no se pueden tocar — el de prioridad porque cambiarlo después de despachar movería el badge del mise pero no la prioridad de la tarea que ya salió. Queda activado hasta que lo apaguen.
