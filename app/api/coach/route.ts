...
Tiene tres pestañas:
- Apertura: al empezar el turno, el cocinero recorre su plaza y marca lo que hay que preparar. Cada ítem muestra como referencia el stock que quedó del cierre del turno anterior (verde = alcanza, amarillo o rojo = hay que producir). Si marca un ítem como SP o P, se crea automáticamente una tarea en Producción. Tildar el ítem en el mise marca esa tarea como lista, y al revés: van sincronizados.
