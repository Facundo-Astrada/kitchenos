-- PLAN-4-CAPAS bloque B2 — campos de la capa Definir en Stock.
-- stock_maximo/merma_esperada_pct/nota_recepcion, ninguno bloqueante (R3/R4).
-- Stock de seguridad NO es columna: se calcula en useStock (stock_minimo × 1.25).
...
-- migraciones reset_demo_* anteriores) para que las 3 columnas nuevas
-- de productos también se clonen al resetear la demo (R1).
