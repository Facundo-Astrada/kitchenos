...
3. **Segundo registro tipográfico**: serif itálica solo para "la voz humana" — notas de plaza, mensajes del pase, respuestas del Coach, subtítulos de guía. Una familia más por Google Fonts (ya se cargan por `<link>` en `app/layout.tsx`).
